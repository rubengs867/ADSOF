...
public class Enlace {
  ...
  /** Constructor
  * En caso del que el coste sea menor o igual a 0, se asigna un coste por defecto de 1 
  ...
  */
  ...
  /**
   * @return Una cadena de texto con la información del enlace, en el formato: (@origen--coste-->@destino)
   */
  @Override
