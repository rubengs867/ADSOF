public class EjemploPruebaUsuario {
  ...
  public static void main(String[] args) {
    ...
    // Aquí ocurre la magia del polimorfismo. Le pedimos a Pepe, pero nos debe devolver a Marina.
    ...
    // Como no hay destinos ALTA o VIRAL en su lista, debe devolver el de Pepe (comportamiento normal).
