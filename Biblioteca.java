...
public class Biblioteca {
    ...
    public Biblioteca(String nombre, List<Libro> libros) {
        ...
        if (libros == null) {
            ...
            this.libros = libros; // haciendo esto si modifican la lista original tambien se modifica la de la
                                  // biblioteca
        }
        ...
        if (libros != null) {
            for (Libro l : libros) {
                this.nuevoLibro(l); // añadimos los libros a la biblioteca, se podría llegar a quitar el this ya que
                                    // se utiliza dentro de la misma clase
            }
        }
