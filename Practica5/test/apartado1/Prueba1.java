...
/**
 * Clase de prueba para demostrar el uso de Dataset, Feature y IFeaturizer
 * sobre conjuntos de datos de personas como indica el enunciado de la práctica.
 */
public class Prueba1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Gender distribution: " +
            dataSet.feature("gender").distribution());
  }

  /**
   * Construye un conjunto de datos de ejemplo.
   *
   * @return dataset con varias personas
   */
