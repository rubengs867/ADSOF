...
public class UsuarioInteresado extends Usuario {
  ...
  /**
   * Construye un usuario interesado con nombre y capacidad de amplificación
   * especificados.
   * Utiliza la lista heredada de la clase padre para mantener el orden de
  ...
  /**
   * Construye un usuario interesado definiendo explícitamente su nivel de
   * exposición inicial.
   * 
   * @param nombre                 El nombre identificador del usuario.
   * @param capacidadAmplificacion La capacidad de amplificación asignada.
   * @param exposicion             El nivel de exposición pública inicial del
   *                               usuario.
   */
   ...
   * 
   * @param destUsuario El usuario destino al que teóricamente va dirigido el
   *                    mensaje.
   * @return El primer enlace hacia un usuario con exposición ALTA/VIRAL, o el
   *         metodo del padre
   * 
   */
  @Override
